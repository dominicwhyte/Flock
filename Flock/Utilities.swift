...
struct FlockColors {
    ...
    static let FLOCK_LIGHT_GRAY = UIColor(red: 233/255, green: 233/255, blue: 233/255, alpha: 1.0)
    ...
    static let FLOCK_LIGHT_GOLD = UIColor(red: 255/255, green: 243/255, blue: 155/255, alpha: 1.0)
}
