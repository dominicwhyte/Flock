...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MVHorizontalPicker/MVHorizontalPicker.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TTHorizontalPicker/TTHorizontalPicker.framework"
