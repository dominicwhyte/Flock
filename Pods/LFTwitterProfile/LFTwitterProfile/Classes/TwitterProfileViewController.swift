...
//      make.edges.equalTo(_segmentedControlContainer).inset(UIEdgeInsetsMake(8, 16, 8, 16))
    ...
    var frame = CGRect(x: self.segmentedControl.frame.maxX, y: self.segmentedControl.frame.maxY, width: self.segmentedControl.frame.width, height: 0.0)
...
//      print(scalingFactor)
  ...
  //    if segmentedControlLocation.origin.y <= navigationHeight {
      ...
      if let titleLabel = profileHeaderView.titleLabel  {
